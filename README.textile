...
h3. Install it
* Install 
<pre> git submodule add git://github.com/saturnflyer/radiant-file-system-resources-extension.git vendor/extensions/file_system_resources
</pre>
* Migrate it
...
* Your newly created layouts/snippets are now available to use in admin panel.g
